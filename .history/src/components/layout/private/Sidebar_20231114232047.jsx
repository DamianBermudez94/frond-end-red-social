    ...
    <>
      <aside className="layout__aside">
        ...
        <div className="aside__container">
          ...
          {stored == "stored" ? <strong className="alert alert-success">El usuario se ha logueado correctamente!!</strong> : "" }
       {stored == "error" ? <strong className="alert alert-error">Error, no se ha podido publicar </strong> : "" }
