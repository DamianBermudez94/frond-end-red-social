...
const UserList = ({
  ...
  console.log(users,getUsers,following,setFollowing,loading,more,page,setPage);
  const { auth } = useAuth();
...
UserList.PropTypes={
    ...
    getUsers: PropTypes.isRequired,
    following: PropTypes.isRequired,
    setFollowing: PropTypes.isRequired,
    loading: PropTypes.isRequired,
    more: PropTypes.isRequired,
    page: PropTypes.isRequired,
    setPage:PropTypes.isRequired
